        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactPhone = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Dislikes = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(0)"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    AgeLimit = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(0)"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dislikes = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(0)"),
                    Duration = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(1)"),
                    ImdbRaiting = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Likes = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(0)"),
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    Trailer = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Movies_Entities",
                        column: x => x.Id,
                        principalTable: "Entities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    DescriptionOfRules = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieActors_Actors",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieActors_Movies",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieCountries_Countries",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieCountries_Movies",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieDirectors_Directors",
                        column: x => x.DirectorId,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieDirectors_Movies",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieLanguages_Languages",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieLanguages_Movies",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieWriters_Movies",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieWriters_Writers",
                        column: x => x.WriterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CinemaPromotions", x => new { x.CinemaId, x.PromotionId });
                    table.ForeignKey(
                        name: "FK_CinemaPromotions_Cinemas",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CinemaPromotions_Promotions",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePromotions", x => new { x.MovieId, x.PromotionId });
                    table.ForeignKey(
                        name: "FK_MoviePromotions_Movies",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePromotions_Promotions",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ColumnNumber = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(0)"),
                    HallId = table.Column<long>(type: "bigint", nullable: false),
                    Identifier = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    IsBusy = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "(0)"),
                    RowNumber = table.Column<int>(type: "int", nullable: false, defaultValueSql: "(0)"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_MovieSessions",
                        column: x => x.MovieSessionId,
                        principalTable: "MovieSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Seats",
                        column: x => x.SeatId,
            ...
            migrationBuilder.CreateIndex(
                name: "AK_Actors_FirstName_LastName",
                table: "Actors",
                columns: new[] { "FirstName", "LastName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CinemaPromotions_PromotionId",
            ...
            migrationBuilder.CreateIndex(
                name: "AK_Directors_FirstName_LastName",
                table: "Directors",
                columns: new[] { "FirstName", "LastName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviePromotions_PromotionId",
            ...
            migrationBuilder.CreateIndex(
                name: "AK_Orders_MovieSessionId_SeatId_CustomerId",
                table: "Orders",
                columns: new[] { "MovieSessionId", "SeatId", "CustomerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Pictures_EntityId",
                table: "Pictures",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "AK_Pictures_Uri",
                table: "Pictures",
                column: "Uri",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "AK_Seats_RowNumber_ColumnNumber_HallId",
                table: "Seats",
                columns: new[] { "RowNumber", "ColumnNumber", "HallId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "AK_SeatTypes_Name",
                table: "SeatTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SessionPrices_SeatTypeId",
                table: "SessionPrices",
                column: "SeatTypeId");

            migrationBuilder.CreateIndex(
                name: "AK_SessionPrices_MovieSessionId_SeatTypeId",
                table: "SessionPrices",
            ...
            migrationBuilder.CreateIndex(
                name: "AK_Writers_FirstName_LastName",
                table: "Writers",
                columns: new[] { "FirstName", "LastName" },
                unique: true);
        }
